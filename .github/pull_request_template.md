...
Describe the user-visible behavior and why this is the smallest complete change.

## Verification

- [ ] **Product > Test** and **Product > Analyze** pass in Xcode.
- [ ] `xcrun swift format lint --recursive BandSteerer BandSteererTests --strict` passes.
...
List the macOS version, architecture, network security type, and scenarios tested. Use generic network names and include no private identifiers.
