...
- Local builds require no Apple account. Public releases use the Xcode project through a tag-triggered GitHub Actions workflow; signing identities and notarization credentials remain encrypted Actions secrets and are never stored in source.
